...
abstract public class SvgElement {
    /** This field, called isParsed, is used as an indicator of 
     *   whether this element has been parsed.
     *  If this element is parsed, we can directly read attribute 
     *   from the hashmap, where information of attributes is stored.
     *  otherwise, we need to parse this element.
     * */
