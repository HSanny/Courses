...
class Fisher():
    ...
    def getWithinClassSum(self):
        '''
         set up a dictionary for computing sum of each class, and return it
         use dictionary effectively improve the speed of this algorithm
         this implementation also have good scalability to datasets of multiple classes
        '''
#{{{
        sumDict = {}
...
#}}}
    ...
    def getWithinClassMean(self):
        '''
         set up a dictionary for computing mean of each class, and return it
        '''
#{{{
        meanDict = {}
...
#{{{
        ...
        for i in range(0, len(self.DATA)):
            ...
            ## compute the difference to mean of its class
...
def classMapping(flowerName):
    ''' this function map the labelled class to 
