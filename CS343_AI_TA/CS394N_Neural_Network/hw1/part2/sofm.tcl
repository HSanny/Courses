...
proc DisplayMap {t} {
    global nx ny canvas epoch message
...
proc Train {} {
    global continuing startt tend message nvectors
...
entry $som.menu.file -relief ridge -width 20 -textvar simufile
pack $som.menu.step $som.menu.reset $som.menu.train $som.menu.quit \
    $som.menu.label $som.menu.file -side left
pack $som.menu -side top -pady 3

set height [expr $nx*(600/$nx)]
set width [expr $nx*(600/$nx)]
