...
int nx, ny, t, t_array[MAXPHASE+1], *t_, tend, seed,
  ...
  testing, labeling, startt, phase, nlabelvectors, nvectors, 
  dim, misclassified, bestmisclassified, secondmisclassified,
  step, oldt, oldtesting;
int shuffletable[MAXVECTORS];
float alpha_array[MAXPHASE+1], *alpha_, best, second;
char simufile[100], vectorfile[100], labelfile[100], labelvectorfile[100],
     labellabelfile[100];
FILE *fp, *fp2;
...
int modify_weights(int nc, float alpha, int inpv);
int init_params(char *arg1, char *arg2);
