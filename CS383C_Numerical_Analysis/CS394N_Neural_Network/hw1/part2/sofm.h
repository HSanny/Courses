...
int nx, ny, t, t_array[MAXPHASE+1], *t_, tend, seed,
  nc_array[MAXPHASE+1], *nc_, besti, bestj, 
  nextsnapshot, snapshots[MAXSNAPS], disp_rate, 
  continuing, testing, startt, phase,
  nvectors, dim, step, oldt, oldtesting;
int shuffletable[MAXVECTORS];
float alpha_array[MAXPHASE+1], *alpha_;
...
inputvectors vectors[MAXVECTORS];
