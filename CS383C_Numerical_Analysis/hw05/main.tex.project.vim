" ATP project vim script: Sat Oct 11, 2014 at 06:18 PM -0400.
...
let b:atp_OutDir = '/Users/JimmyLin/workspace/ProgressedCourses/CS383C_Numerical_Analysis/hw05'
...
let b:atp_LocalCommands = ['\bu', '\dchi', '\cchi', '\ckappa', '\cp{', '\ect{', '\ecp{', '\ycheck']
