...
public class Compiler {
    ...
    public void printInOrder() {
        ...
        InOrderVisitor IOV = new InOrderVisitor ();
        tree().accept(IOV);
        System.out.println(IOV.getResult());
    }
    ...
    public void printBreathFirst() {
        // initilise one new visitor
        BreadthFirstVisitor BFV = new BreadthFirstVisitor ();
        // use accept pattern to tranverse the expression tree
        tree().accept(BFV);
        System.out.print("Breadth-First: ");
        System.out.println(BFV.getResult());
    }
